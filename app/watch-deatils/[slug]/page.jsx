          ...
          <div className="container mx-auto pt-[30px]">
            <div className="flex lg:flex-row flex-col p-[20px] md:p-[40px] items-center bg-[#f3f3f3] gap-10">
              ...
              <div className="lg:max-w-[60%] ">
                ...
                <h4 className=" text-[18px] md:px-1 capitalize font-bold">Details</h4>
                <div>
                  <h5 className="font-['Red_Hat_Display'] text-[14px] leading-[26px] md:px-1 whitespace-nowrap">
                    <span className="font-semibold text-[16px] ">Size :</span> {data?.size}
                  </h5>
                  <h5 className="font-['Red_Hat_Display'] text-[14px] leading-[26px] md:px-1 whitespace-nowrap">
                    <span className="font-semibold text-[16px] ">Fits wrists in sizes :</span>{" "}
                    {data?.fitsWristSizes}
                  </h5>
                  <h5 className="font-['Red_Hat_Display'] text-[14px] leading-[26px] md:px-1 whitespace-nowrap">
                    <span className="font-semibold text-[16px] ">Material :</span> {data?.material}
                  </h5>
                  <h5 className="font-['Red_Hat_Display'] text-[14px] leading-[26px] md:px-1 whitespace-nowrap">
                    <span className="font-semibold text-[16px] ">Lug Width :</span> {data?.lugWidth}
                  </h5>
                </div>
